...
### Set core controls
apollo_control = list(
  modelName       = "MXL RP ID, uncorrelated lognormals in preference space",
  modelDescr      = "MXL RP ID, uncorrelated lognormals in preference space",
  indivID         = "id",
  nCores          = 4,
...
kable(output, caption = "MXL RP Model (ID) Estimates with p-values")
```