...
Model: Simple Latent class model for 2 class, no covariates in class allocation model, separated SP vs RP
...
kable(output, caption = "Estimates of LC Model for 2 classes for SP Data with p-values")
```

Now, we analyse the RP Data
...
kable(output, caption = "Estimates of LC Model for 2 classes for RP Data with p-values")
```

Now, we try the joint SP-RP data
