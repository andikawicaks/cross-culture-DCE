...
### Set core controls
apollo_control = list(
  modelName       = "Joint MNL SP-RP",
  modelDescr      = "Joint MNL SP-RP",
  indivID         = "id", 
...
kable(output, caption = "MNL SP-RP Model Estimates with p-values")
```