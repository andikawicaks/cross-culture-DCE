...
### Set core controls
apollo_control = list(
  modelName       = "MXL SP ID, uncorrelated lognormals in preference space",
  modelDescr      = "MXL SP ID, uncorrelated lognormals in preference space",
  indivID         = "id",
  nCores          = 4,
...
kable(output, caption = "MXL SP Model (ID) Estimates with p-values")
```