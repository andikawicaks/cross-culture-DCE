...
### Set core controls
apollo_control = list(
  modelName       = "MXL RP DK, uncorrelated lognormals in preference space",
  modelDescr      = "MXL RP DK, uncorrelated lognormals in preference space",
  indivID         = "id",
  nCores          = 4,
...
kable(output, caption = "MXL RP Model (DK) Estimates with p-values")
```