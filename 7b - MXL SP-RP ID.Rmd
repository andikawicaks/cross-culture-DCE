...
### Set core controls
apollo_control = list(
  modelName       = "Joint MXL SP-RP, uncorrelated lognormals in preference space, Indonesian data",
  modelDescr      = "Joint MXL SP-RP, uncorrelated lognormals in preference space, Indonesian data",
  indivID         = "id",
  nCores          = 4,
...
kable(output, caption = "MXL SP-RP Model (Indonesia) Estimates with p-values")
```