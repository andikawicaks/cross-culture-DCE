...
Model: Simple Latent class model for 3 class, no covariates in class allocation model
...
apollo_lcPars=function(apollo_beta, apollo_inputs){
  lcpars = list()
  lcpars[["beta_hedonic"]] = list(b_hedonic_1, b_hedonic_2, b_hedonic_3)
...
kable(output, caption = "Estimates of LC Model for 3 classes with p-values")
```