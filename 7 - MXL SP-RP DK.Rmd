...
### Set core controls
apollo_control = list(
  modelName       = "Joint MXL SP-RP, uncorrelated lognormals in preference space",
  modelDescr      = "Joint MXL SP-RP, uncorrelated lognormals in preference space",
  indivID         = "id",
  nCores          = 4,
...
kable(output, caption = "MXL SP-RP Model Estimates with p-values")
```