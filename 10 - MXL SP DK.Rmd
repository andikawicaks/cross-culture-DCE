...
### Set core controls
apollo_control = list(
  modelName       = "MXL SP DK, uncorrelated lognormals in preference space",
  modelDescr      = "MXL SP DK, uncorrelated lognormals in preference space",
  indivID         = "id",
  nCores          = 4,
...
output$Estimate_rescaled <- output$Estimate / 10
output$Rob.s.e._rescaled <- output$Rob.s.e. / 10
```
...
kable(output, caption = "MXL SP Model (DK) Estimates with p-values")
```