...
### Set core controls
apollo_control = list(
  modelName       = "Simple MNL SP",
  modelDescr      = "Simple MNL SP",
  indivID         = "id", 
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[["choice1"]]  = asc_1 + b_hedonic  * alt1_value + b_arabica * alt1_arabica + b_half * alt1_half + b_normal * alt1_normal + b_fairtrade * alt1_fairtrade + b_organic * alt1_organic   
  V[["choice2"]]  = asc_2 + b_hedonic  * alt2_value + b_arabica * alt2_arabica + b_half * alt2_half + b_normal * alt2_normal + b_fairtrade * alt2_fairtrade + b_organic * alt2_organic 
  V[["choice3"]]  = asc_3 + b_hedonic  * alt3_value + b_arabica * alt3_arabica + b_half * alt3_half + b_normal * alt3_normal + b_fairtrade * alt3_fairtrade + b_organic * alt3_organic
...
library(knitr)
kable(output, caption = "Apollo Model Estimates with p-values")
library(gt)

output %>%
  gt() %>%
  tab_header(title = "Apollo Model Estimates and Significance") %>%
  cols_label(
    Estimate = "Estimate",
    `s.e.` = "Std. Error",
    `t.rat.(0)` = "t-ratio",
    p_value = "p-value",
    `Rob.s.e.` = "Robust SE",
    `Rob.t.rat.(0)` = "Robust t-ratio",
    Robust_p = "Robust p-value"
  )
